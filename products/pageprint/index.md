---
layout: default
title: Pageprint · One click. The whole page.
description: "Capture an ordinary scrolling webpage as one local PNG."
...
<div class="product-shell">
  <article class="pageprint-panel">
    ...
    <section class="product-section pageprint-boundary" aria-labelledby="boundary-title">
      <p class="product-kicker">Built and tested for the ordinary web</p>
      <h2 id="boundary-title">Useful results, honest boundaries.</h2>
