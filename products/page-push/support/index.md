...
<div class="product-shell">
  <nav class="product-nav" aria-label="Page Push navigation"><a href="/products/page-push/">Page Push</a><div class="product-nav-links"><a href="/products/page-push/privacy/">Privacy</a><a href="/products/page-push/changelog/">Changelog</a></div></nav>
  <article class="product-document-card">
    ...
    <section class="document-section"><h2>Contact</h2><p>For Page Push support, email <a href="mailto:krwill@fastmail.com">krwill@fastmail.com</a>. Include the Chrome version, Page Push version, and the visible error message. Do not send authorization tokens.</p></section>
  </article>
</div>
