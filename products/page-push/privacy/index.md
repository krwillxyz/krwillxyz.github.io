...
<div class="product-shell">
  <article class="product-document-card">
    ...
    <section class="document-section"><h2>Removing data</h2><p>Removing the extension clears Page Push data stored by browser. Data previously delivered to your endpoint is governed by that endpoint and must be removed there.</p></section>
