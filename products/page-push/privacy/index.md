...
<div class="product-shell">
  <article class="product-document-card">
    ...
    <p class="document-intro">Page Push has no account system, hosted backend, analytics, advertising, or telemetry. It sends a page event only when you click <strong>Push page</strong>, and only to the HTTPS API endpoint saved in your local Chrome settings.</p>
